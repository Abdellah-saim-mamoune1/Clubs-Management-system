...
import AccountImage from "../../../assets/Profile.jpg";
export function Account() {
 ...
 const handleCropSave = useCallback(async () => {
  ...
  try {
    ...
    const success = await UpdateStudentImageAPIAsync(croppedFile);
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 border-b border-b-gray-300 pb-6">
            <div className="relative">
              <img
                src={`http://localhost:8102/api/user/${clientInfo.id}/image?v=${imageVersion}`}
              
                onError={(e) => {
                e.currentTarget.src = AccountImage;
                   }}
